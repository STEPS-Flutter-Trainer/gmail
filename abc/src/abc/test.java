...
public class test {
	...
	try {
			  ...
			  final String user ="";//from email
			  final String pass="";//from email password
	...
	public static void main(String[] args)  throws MessagingException, Exception {
		...
		String ToEmail="riminabijish@spectrum.net.in"; // to email addrerss
		String ToUserName="priyanka"; // to username
